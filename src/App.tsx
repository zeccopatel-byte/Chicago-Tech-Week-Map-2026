...
const COMPANIES = [
  ...
  { id: '22', name: 'Founder Fest Chicago (During TechChicago)', color: '#a3a3a3', lat: 41.8865, lng: -87.6179, logo: '🚀', date: 'Jul 21', time: 'TBA', desc: 'Three Cities Social Club (Wicker Park)', url: 'http://www.kampevents.com/events/founder-fest-chicago', theme: 'Founders' },
  { id: '23', name: 'Women Investing / Investing in Women', color: '#a3a3a3', lat: 41.8877, lng: -87.6255, logo: '💸', date: 'Jul 21', time: 'TBA', desc: 'MATTER', url: 'http://lp.constantcontactpages.com/ev/reg/r83mxxz/lp/ff1e6291-c2a5-42e8-bddc-718006083d9f', theme: 'Investors: VC/Angel' },
  ...
  { id: '36', name: 'Quantum Roundtable: What\'s Your Business \'Qase\'?', color: '#a3a3a3', lat: 41.8771, lng: -87.6423, logo: '🚀', date: 'Jul 21', time: 'TBA', desc: 'Union League Club of Chicago', url: 'http://theqampus.club/upcoming-events', theme: 'Founders' },
  ...
  { id: '38', name: 'Founders & Funders™: Chicago VC Reverse Pitch™', color: '#a3a3a3', lat: 41.8917, lng: -87.6366, logo: '🚀', date: 'Jul 21', time: 'TBA', desc: 'mHUB', url: 'http://luma.com/fnfxchi0726', theme: 'Founders' },
  ...
  { id: '54', name: 'Women Founders Crushing It', color: '#a3a3a3', lat: 41.8911, lng: -87.6361, logo: '🚀', date: 'Jul 22', time: 'TBA', desc: 'Bureau Gravity, Aurora, IL', url: 'http://docs.google.com/forms/d/e/1FAIpQLSeipqoXCBrxuTJLq2q_GNHhvOZ4U5dH6UIAygX_eO3BOK8XPw/viewform', theme: 'Founders' },
  ...
  { id: '57', name: 'The Next Horizon: Summer Soirée for Tech & Marketing', color: '#a3a3a3', lat: 41.8842, lng: -87.6277, logo: '🎉', date: 'Jul 23', time: 'TBA', desc: 'Hoste', url: 'http://luma.com/wrts6agi', theme: 'Culture/Arts/Entertainment' },
  { id: '58', name: 'Web3 Investor Day', color: '#a3a3a3', lat: 41.8897, lng: -87.6327, logo: '💸', date: 'Jul 23', time: 'TBA', desc: 'Willis Tower - Convene', url: 'http://www.decasonic.com/web3-investor-day-2026', theme: 'Investors: VC/Angel' },
