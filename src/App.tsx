...
const COMPANIES = [
  ...
  { id: '24', name: 'RichieBot', color: '#a3a3a3', lat: 41.881, lng: -87.645, logo: '🤖', date: 'Jul Art Exhibit & Documentary Film Experience', time: 'TBA', desc: '21', url: 'Vault Gallerie', theme: 'Artificial Intelligence' },
