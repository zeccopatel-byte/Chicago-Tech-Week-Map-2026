...
const COMPANIES = [
  ...
  { id: '2', name: 'Chicago Sports Tech Week', color: '#a3a3a3', lat: 41.8841, lng: -87.623, logo: '🏀', date: 'Jul 20', time: 'TBA', desc: 'Multiple Events', url: 'http://chicagosportstechweek.com/', theme: 'Sports' },
  ...
  { id: '4', name: 'TCW2026: Basecamp @ TechNexus', color: '#a3a3a3', lat: 41.879, lng: -87.6206, logo: '🎉', date: 'Jul 20', time: 'TBA', desc: 'TeamWorking by TechNexus', url: 'http://luma.com/00tj0fik', theme: 'Culture/Arts/Entertainment' },
  ...
  { id: '7', name: 'Future of Commerce Summit: Discover, Build, Launch', color: '#a3a3a3', lat: 41.8855, lng: -87.6312, logo: '💵', date: 'Jul 20', time: 'TBA', desc: 'Kennedy-King College', url: 'http://www.gechamber.com/futureofcommerce', theme: 'Finance' },
  { id: '8', name: 'TechChicago Week KICKoff', color: '#a3a3a3', lat: 41.8893, lng: -87.6386, logo: '🎉', date: 'Jul 20', time: 'TBA', desc: 'Skyline Pitch Chicago', url: 'http://luma.com/tjn94z5t', theme: 'Culture/Arts/Entertainment' },
  { id: '9', name: 'Grassroots Founder Pitch Kickoff', color: '#41B6E6', lat: 41.8854, lng: -87.6151, logo: '🚀', date: 'Jul 20', time: 'TBA', desc: 'Provided Upon Registration', url: 'http://luma.com/grassroots-pitch2026', theme: 'Startup' },
  { id: '10', name: 'A Seat at the Cap Table: We Don\'t Wait for Invitations', color: '#a3a3a3', lat: 41.8736, lng: -87.6345, logo: '🤖', date: 'Jul 20', time: 'TBA', desc: 'Provided upon registration', url: 'http://luma.com/wlci6n0y', theme: 'Artificial Intelligence' },
  ...
  { id: '16', name: 'AI in the Product Development Life Cycle', color: '#a3a3a3', lat: 41.8937, lng: -87.6315, logo: '🤖', date: 'Jul 21', time: 'TBA', desc: 'Aon Center', url: 'http://forms.office.com/pages/responsepage.aspx?id=KFGnnESilkWHe_JIKOR24onNtour8I9LpJFpwcJfWE5UQjBWMVpCV1IyOUVEQzlPSVdDSElLRk1CUy4u', theme: 'Artificial Intelligence' },
  ...
  { id: '18', name: 'TechWalk', color: '#a3a3a3', lat: 41.8739, lng: -87.63, logo: '🎉', date: 'Jul 21', time: 'TBA', desc: 'Chicago Riverwalk', url: 'http://luma.com/71ieg50p', theme: 'Culture/Arts/Entertainment' },
  ...
  { id: '22', name: 'Founder Fest Chicago (During TechChicago)', color: '#a3a3a3', lat: 41.8865, lng: -87.6179, logo: '🚀', date: 'Jul 21', time: 'TBA', desc: 'Three Cities Social Club (Wicker Park)', url: 'http://www.kampevents.com/events/founder-fest-chicago', theme: 'Startup' },
  { id: '23', name: 'Women Investing / Investing in Women', color: '#a3a3a3', lat: 41.8877, lng: -87.6255, logo: '💸', date: 'Jul 21', time: 'TBA', desc: 'MATTER', url: 'http://lp.constantcontactpages.com/ev/reg/r83mxxz/lp/ff1e6291-c2a5-42e8-bddc-718006083d9f', theme: 'Finance' },
  { id: '24', name: 'RichieBot | Art Exhibit & Documentary Film Experience', color: '#a3a3a3', lat: 41.881, lng: -87.645, logo: '🤖', date: 'Jul 21', time: 'TBA', desc: 'Vault Gallerie', url: 'https://luma.com/0o9262vi', theme: 'Artificial Intelligence' },
  ...
  { id: '26', name: 'Women Who Lead @ Chicago Tech Week', color: '#a3a3a3', lat: 41.8942, lng: -87.6158, logo: '👩‍💻', date: 'Jul 21', time: 'TBA', desc: 'Porter Kitchen + Deck', url: 'http://luma.com/vy9r24a4', theme: 'Women in Tech' },
  ...
  { id: '28', name: 'Chicago Demo Day', color: '#a3a3a3', lat: 41.8714, lng: -87.6272, logo: '🎉', date: 'Jul 21', time: 'TBA', desc: 'Norton Rose Fulbright', url: 'http://www.eventbrite.com/e/chicago-demo-day-tickets-1991000515137?aff=oddtdtcreator', theme: 'Culture/Arts/Entertainment' },
  { id: '29', name: 'Building Bridges 2: Investors Meeting Investors', color: '#41B6E6', lat: 41.8881, lng: -87.6157, logo: '💸', date: 'Jul 21', time: 'TBA', desc: '—', url: 'http://luma.com/r9psk5vt', theme: 'Business' },
  { id: '30', name: 'So, You Want To Start A Business?', color: '#41B6E6', lat: 41.8942, lng: -87.6443, logo: '🚀', date: 'Jul 21', time: 'TBA', desc: 'TechNexus Venture Collaborative', url: 'http://queerconnectionsmoc.club/#upcoming-events', theme: 'Business' },
  { id: '31', name: 'AI & Quantum Security Beyond the Perimeter', color: '#a3a3a3', lat: 41.8752, lng: -87.6348, logo: '🤖', date: 'Jul 21', time: 'TBA', desc: 'Provided Upon Registration', url: 'http://luma.com/gopher-mcp-techweek', theme: 'Artificial Intelligence' },
  { id: '32', name: 'Health2Tech Chicago', color: '#41B6E6', lat: 41.8856, lng: -87.628, logo: '🧬', date: 'Jul 21', time: 'TBA', desc: 'Chicago', url: 'http://luma.com/zbe7g6nt', theme: 'Health' },
  ...
  { id: '34', name: 'Chicago Defense and National Security Tech Social', color: '#a3a3a3', lat: 41.88, lng: -87.6392, logo: '🎉', date: 'Jul 21', time: 'TBA', desc: 'Alumni Ventures LaSalle-Wacker Building', url: 'http://luma.com/chicago-defense-tech-social-2026', theme: 'Culture/Arts/Entertainment' },
  { id: '35', name: 'Startup Pitch Competition', color: '#41B6E6', lat: 41.8736, lng: -87.6154, logo: '🚀', date: 'Jul 21', time: 'TBA', desc: 'Fulton Market', url: 'http://chicagosportstechweek.com/startup-pitch', theme: 'Startup' },
  { id: '36', name: 'Quantum Roundtable: What\'s Your Business \'Qase\'?', color: '#a3a3a3', lat: 41.8771, lng: -87.6423, logo: '🚀', date: 'Jul 21', time: 'TBA', desc: 'Union League Club of Chicago', url: 'http://theqampus.club/upcoming-events', theme: 'Startup' },
  { id: '37', name: 'Digital Delivery Chicago Meetup', color: '#a3a3a3', lat: 41.879, lng: -87.6256, logo: '🎉', date: 'Jul 21', time: 'TBA', desc: 'Aon Center', url: 'http://www.meetup.com/js-chi/events/312068434/', theme: 'Culture/Arts/Entertainment' },
  { id: '38', name: 'Founders & Funders™: Chicago VC Reverse Pitch™', color: '#a3a3a3', lat: 41.8917, lng: -87.6366, logo: '🚀', date: 'Jul 21', time: 'TBA', desc: 'mHUB', url: 'http://luma.com/fnfxchi0726', theme: 'Startup' },
  { id: '39', name: 'RCS: The New Way to Interact with Customers via Texts', color: '#a3a3a3', lat: 41.8774, lng: -87.629, logo: '🎉', date: 'Jul 22', time: 'TBA', desc: 'Teamworking by TechNexus', url: 'http://nativemsg.com/chicago-tech-week-event-signup', theme: 'Culture/Arts/Entertainment' },
  ...
  { id: '46', name: 'Velocity through Community: Human-Forward AI', color: '#a3a3a3', lat: 41.8846, lng: -87.6267, logo: '🤖', date: 'Jul 22', time: 'TBA', desc: 'The Metropolitan', url: 'http://www.eventbrite.com/e/velocity-through-community-solving-grand-challenges-via-human-forward-ai-tickets-1989831909807', theme: 'Artificial Intelligence' },
  { id: '47', name: 'Partnerships Powering the Future of Healthcare AI', color: '#41B6E6', lat: 41.8868, lng: -87.6408, logo: '🤖', date: 'Jul 22', time: 'TBA', desc: 'MATTER', url: 'http://luma.com/b9a7bqgw', theme: 'Health' },
  ...
  { id: '50', name: 'Pixels & Prosecco: Women in Tech Mixer', color: '#a3a3a3', lat: 41.8917, lng: -87.6314, logo: '👩‍💻', date: 'Jul 22', time: 'TBA', desc: 'Provided upon registration', url: 'http://luma.com/3cy28qcq', theme: 'Women in Tech' },
  { id: '51', name: '10th Annual Summer Pitch Battle & Party', color: '#41B6E6', lat: 41.873, lng: -87.6269, logo: '🚀', date: 'Jul 22', time: 'TBA', desc: 'Chicago', url: 'http://www.startupgrind.com/events/details/startup-grind-chicago-presents-10th-annual-summer-pitch-battle-amp-party/', theme: 'Startup' },
  { id: '52', name: 'The Marketing Hot Seat: TechWeek Edition', color: '#41B6E6', lat: 41.871, lng: -87.6386, logo: '🎉', date: 'Jul 22', time: 'TBA', desc: 'Fabrik Chicago', url: 'http://luma.com/xu9e5l89', theme: 'Marketing' },
  { id: '53', name: 'Just Ai Foundation: A Future Worth Imagining', color: '#a3a3a3', lat: 41.8943, lng: -87.6216, logo: '🤖', date: 'Jul 22', time: 'TBA', desc: 'Provided Upon Registration', url: 'http://www.eventbrite.com/e/just-ai-foundation-a-future-worth-imagining-tickets-1991428993728', theme: 'Artificial Intelligence' },
  { id: '54', name: 'Women Founders Crushing It', color: '#a3a3a3', lat: 41.8911, lng: -87.6361, logo: '🚀', date: 'Jul 22', time: 'TBA', desc: 'Bureau Gravity, Aurora, IL', url: 'http://docs.google.com/forms/d/e/1FAIpQLSeipqoXCBrxuTJLq2q_GNHhvOZ4U5dH6UIAygX_eO3BOK8XPw/viewform', theme: 'Startup' },
  ...
  { id: '56', name: 'SparkLabs Founder Dinner', color: '#41B6E6', lat: 41.8757, lng: -87.6215, logo: '🚀', date: 'Jul 22', time: 'TBA', desc: '—', url: 'http://partiful.com/e/y0OjQV0FTtkqHxrSiVYH', theme: 'Startup' },
  { id: '57', name: 'The Next Horizon: Summer Soirée for Tech & Marketing', color: '#a3a3a3', lat: 41.8842, lng: -87.6277, logo: '🎉', date: 'Jul 23', time: 'TBA', desc: 'Hoste', url: 'http://luma.com/wrts6agi', theme: 'Marketing' },
  { id: '58', name: 'Web3 Investor Day', color: '#a3a3a3', lat: 41.8897, lng: -87.6327, logo: '💸', date: 'Jul 23', time: 'TBA', desc: 'Willis Tower - Convene', url: 'http://www.decasonic.com/web3-investor-day-2026', theme: 'Web3' },
  ...
  { id: '61', name: 'Passport to Founders', color: '#a3a3a3', lat: 41.8928, lng: -87.6382, logo: '🏀', date: 'Jul 23', time: 'TBA', desc: 'Fabrik Chicago', url: 'http://luma.com/e1d75gnn', theme: 'Sports' },
  ...
  { id: '64', name: 'WMN Fintech Showcase', color: '#a3a3a3', lat: 41.888, lng: -87.6378, logo: '👩‍💻', date: 'Jul 23', time: 'TBA', desc: 'BMO Tower - 320 S Canal', url: 'http://luma.com/3i1kqqac', theme: 'Women in Tech' },
  { id: '65', name: 'The Voucher Networking Mixer', color: '#a3a3a3', lat: 41.8723, lng: -87.6213, logo: '🎉', date: 'Jul 23', time: 'TBA', desc: '20 N Wacker Dr, 15th Fl', url: 'http://luma.com/268wtsd0', theme: 'Culture/Arts/Entertainment' },
  { id: '66', name: 'Milna Launch Party @ TeamWorking', color: '#a3a3a3', lat: 41.8864, lng: -87.6435, logo: '🎉', date: 'Jul 23', time: 'TBA', desc: 'Teamworking by TechNexus', url: 'http://luma.com/q3ead560', theme: 'Culture/Arts/Entertainment' },
  ...
  { id: '71', name: 'Fundraising for the Rest of Us', color: '#a3a3a3', lat: 41.8844, lng: -87.626, logo: '🤖', date: 'Jul 23', time: 'TBA', desc: 'Three Cities Social Club', url: 'http://luma.com/qwvogdy9', theme: 'Artificial Intelligence' },
  ...
  { id: '73', name: 'Building Resilient Communities Brunch', color: '#a3a3a3', lat: 41.8774, lng: -87.6163, logo: '🎉', date: 'Jul 24', time: 'TBA', desc: 'Ovation Chicago', url: 'http://luma.com/0uaoipd4', theme: 'Culture/Arts/Entertainment' },
  { id: '74', name: 'AI Voices: The Translation Layer', color: '#a3a3a3', lat: 41.8747, lng: -87.6395, logo: '🤖', date: 'Jul 24', time: 'TBA', desc: 'Microsoft Tech Center, Aon Center', url: 'http://www.ticketfalcon.com/e/alvoices2026/', theme: 'Artificial Intelligence' },
  { id: '75', name: 'Fastest Draw in the 312', color: '#a3a3a3', lat: 41.8893, lng: -87.6246, logo: '🎉', date: 'Jul 24', time: 'TBA', desc: 'Provided Upon Registration', url: 'http://luma.com/2o7ethm3', theme: 'Culture/Arts/Entertainment' },
  ...
  { id: '78', name: "Aspen Ideas: Climate 2026", color: '#a3a3a3', lat: 41.8865, lng: -87.6169, logo: '🎉', date: 'Jul 21', time: 'TBA', desc: "Convene, Willis Tower", url: "https://register.aspenideasclimate.org/event/2026/regProcessStep1?RefId=Web_2&amp;rt=IfqDQJSUf0WTz15FjyPwMw", theme: 'Culture/Arts/Entertainment' },
  { id: '79', name: "PROMPT. AI Innovation Series", color: '#a3a3a3', lat: 41.8632, lng: -87.6165, logo: '🎉', date: 'Jul 21', time: 'TBA', desc: "Cine City Studios", url: "https://luma.com/5v7dnv8w", theme: 'Culture/Arts/Entertainment' },
  { id: '80', name: "Business Development Prodigy x Order A Robot: The Future of Robotics, AI, and Tech", color: '#a3a3a3', lat: 41.8710, lng: -87.6170, logo: '🎉', date: 'Jul 21', time: 'TBA', desc: "Provided Upon Registration", url: "https://order-a-robot.com", theme: 'Business' },
  { id: '81', name: "&#8220;From Me to We&#8221;: Women Founders &#038; Operators Community Coffee &#038; Kickoff @ TechChicago Week", color: '#a3a3a3', lat: 41.8695, lng: -87.6386, logo: '🎉', date: 'Jul 21', time: 'TBA', desc: "Provided Upon Registration", url: "https://luma.com/a25vkuh7", theme: 'Culture/Arts/Entertainment' },
  { id: '82', name: "​TCW2026: Basecamp @ TechNexus", color: '#a3a3a3', lat: 41.8894, lng: -87.6290, logo: '🎉', date: 'Jul 21', time: 'TBA', desc: "TeamWorking by TechNexus", url: "https://luma.com/00tj0fik", theme: 'Culture/Arts/Entertainment' },
...
export default function App() {
  ...
  const THEMES = [
    'All Themes', 'Artificial Intelligence', 'Business', 'Climate', 
    'Culture/Arts/Entertainment', 'Finance', 
    'Founders', 'Health', 'Investors: VC/Angel', 
    'LGBTQIA+ in Tech', 'Life Sciences', 
    'Marketing', 'Sports', 'Startup', 'Web3', 'Women in Tech'
  ];
  ...
  const isMobileModalOpen = isMobile && (isFilterOpen || isDayFilterOpen || selectedCompany !== null || isListOpen);
    ...
    <div className={`w-screen h-screen overflow-hidden flex flex-col md:flex-row font-sans transition-colors duration-300 ${isDarkMode ? 'bg-black text-white' : 'bg-gray-50 text-neutral-900'}`}>
      ...
      <div className="flex-1 relative order-2 md:order-1 h-full md:h-full group">
        <Map
          ...
          interactiveLayerIds={[]}
          scrollZoom={!isMobileModalOpen}
          dragPan={!isMobileModalOpen}
          dragRotate={!isMobileModalOpen}
          doubleClickZoom={!isMobileModalOpen}
          touchZoomRotate={!isMobileModalOpen}
        ...
        <div className="hidden md:flex absolute bottom-6 left-1/2 -translate-x-1/2 bg-black/60 backdrop-blur-lg px-4 py-2 rounded-full border border-white/10 text-xs font-semibold tracking-widest text-neutral-400 shadow-2xl pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity items-center gap-2">
            <span className="w-1.5 h-1.5 bg-[#ffffff] rounded-full animate-pulse"></span>
        ...
        {isMobile && selectedCompany && (
          <>
            <div className="fixed inset-0 bg-black/40 z-[55] md:hidden" onClick={() => setSelectedCompany(null)} />
            <div className={`fixed bottom-0 left-0 right-0 p-5 rounded-t-3xl border-t shadow-2xl backdrop-blur-3xl z-[60] transform transition-transform duration-300 md:hidden ${isDarkMode ? 'bg-[#1c1c1e]/95 border-white/10 text-white' : 'bg-white/95 border-black/10 text-gray-900'}`}>
               <div className="flex justify-between items-start mb-3">
                   <div className="flex items-center gap-2">
                      <div className="w-10 h-10 flex items-center justify-center rounded-xl text-lg shrink-0 shadow-sm" style={{
                         backgroundColor: isDarkMode ? '#41B6E630' : '#41B6E615',
                   ...
                   <button onClick={() => setSelectedCompany(null)} className={`shrink-0 p-2 rounded-full ${isDarkMode ? 'bg-white/10 hover:bg-white/20' : 'bg-black/5 hover:bg-black/10'}`}>
                      <X className="w-5 h-5" />
                   </button>
               </div>
